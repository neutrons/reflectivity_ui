...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolBox.setMinimumSize(QtCore.QSize(0, 270))
        self.toolBox.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.toolBox.setLineWidth(0)
        self.toolBox.setObjectName("toolBox")
        self.page = QtWidgets.QWidget()
        self.page.setGeometry(QtCore.QRect(0, 0, 348, 183))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 336, 163))
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 227, 115))
        ...
        self.offspec_x_min_spinbox = QtWidgets.QDoubleSpinBox(self.groupBox)
        ...
        self.horizontalLayout_19.addWidget(self.offspec_x_min_spinbox)
        self.label_41 = QtWidgets.QLabel(self.groupBox)
        self.label_41.setObjectName("label_41")
        self.horizontalLayout_19.addWidget(self.label_41)
        self.offspec_x_max_spinbox = QtWidgets.QDoubleSpinBox(self.groupBox)
        ...
        self.horizontalLayout_19.addWidget(self.offspec_x_max_spinbox)
        ...
        self.offspec_y_min_spinbox = QtWidgets.QDoubleSpinBox(self.groupBox)
        ...
        self.horizontalLayout_19.addWidget(self.offspec_y_min_spinbox)
        self.label_43 = QtWidgets.QLabel(self.groupBox)
        self.label_43.setObjectName("label_43")
        self.horizontalLayout_19.addWidget(self.label_43)
        self.offspec_y_max_spinbox = QtWidgets.QDoubleSpinBox(self.groupBox)
        ...
        self.horizontalLayout_19.addWidget(self.offspec_y_max_spinbox)
        ...
        self.offspec_rebin_x_bins_label = QtWidgets.QLabel(self.groupBox)
        self.offspec_rebin_x_bins_label.setObjectName("offspec_rebin_x_bins_label")
        self.horizontalLayout_19.addWidget(self.offspec_rebin_x_bins_label)
        self.offspec_rebin_x_bins_spinbox = QtWidgets.QSpinBox(self.groupBox)
        ...
        self.horizontalLayout_19.addWidget(self.offspec_rebin_x_bins_spinbox)
        spacerItem7 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_19.addItem(spacerItem7)
        self.offspec_rebin_y_bins_label = QtWidgets.QLabel(self.groupBox)
        self.offspec_rebin_y_bins_label.setToolTip("")
        self.offspec_rebin_y_bins_label.setObjectName("offspec_rebin_y_bins_label")
        self.horizontalLayout_19.addWidget(self.offspec_rebin_y_bins_label)
        self.offspec_rebin_y_bins_spinbox = QtWidgets.QSpinBox(self.groupBox)
        ...
        self.horizontalLayout_19.addWidget(self.offspec_rebin_y_bins_spinbox)
        ...
        self.offspec_sigmax_spinbox = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.offspec_sigmax_spinbox.setDecimals(5)
        self.offspec_sigmax_spinbox.setMaximum(0.01)
        self.offspec_sigmax_spinbox.setSingleStep(1e-05)
        self.offspec_sigmax_spinbox.setProperty("value", 0.0005)
        self.offspec_sigmax_spinbox.setObjectName("offspec_sigmax_spinbox")
        self.horizontalLayout_17.addWidget(self.offspec_sigmax_spinbox)
        ...
        self.offspec_sigmay_spinbox = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.offspec_sigmay_spinbox.setDecimals(5)
        self.offspec_sigmay_spinbox.setMaximum(0.01)
        self.offspec_sigmay_spinbox.setSingleStep(1e-05)
        self.offspec_sigmay_spinbox.setProperty("value", 0.0005)
        self.offspec_sigmay_spinbox.setObjectName("offspec_sigmay_spinbox")
        self.horizontalLayout_17.addWidget(self.offspec_sigmay_spinbox)
        ...
        self.offspec_sigmas_spinbox = QtWidgets.QSpinBox(self.groupBox)
        self.offspec_sigmas_spinbox.setProperty("value", 3)
        self.offspec_sigmas_spinbox.setObjectName("offspec_sigmas_spinbox")
        self.horizontalLayout_17.addWidget(self.offspec_sigmas_spinbox)
        ...
        self.horizontalLayout_18.addWidget(self.offspec_slice_checkbox)
        ...
        self.offspec_qz_list_edit = QtWidgets.QLineEdit(self.groupBox)
        self.offspec_qz_list_edit.setObjectName("offspec_qz_list_edit")
        self.horizontalLayout_18.addWidget(self.offspec_qz_list_edit)
        ...
        self.offspec_err_weight_checkbox.setChecked(True)
        self.offspec_err_weight_checkbox.setObjectName("offspec_err_weight_checkbox")
        self.horizontalLayout_18.addWidget(self.offspec_err_weight_checkbox)
        ...
        self.frame_gisans_pp = QtWidgets.QFrame(self.gisansTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.frame_gisans_sf = QtWidgets.QFrame(self.gisansTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.rightPlots.setMinimumSize(QtCore.QSize(350, 0))
        ...
        self.x_project.setMinimumSize(QtCore.QSize(150, 200))
        ...
        self.y_project.setMinimumSize(QtCore.QSize(150, 200))
        ...
        self.refl.setMinimumSize(QtCore.QSize(150, 200))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1870, 20))
        ...
        self.bgCenter.editingFinished.connect(MainWindow.changeRegionValues)
        self.refXWidth.editingFinished.connect(MainWindow.changeRegionValues)
        self.bgWidth.editingFinished.connect(MainWindow.changeRegionValues)
        ...
        MainWindow.setTabOrder(self.offspecImax, self.gisansImin)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_23.setText(_translate("MainWindow", "Sigma_x"))
        self.offspec_sigmax_spinbox.setToolTip(_translate("MainWindow", "Standard deviation in X"))
        self.offspec_sigmax_spinbox.setSuffix(_translate("MainWindow", " 1/A"))
        self.label_40.setText(_translate("MainWindow", "Sigma_y"))
        self.offspec_sigmay_spinbox.setToolTip(_translate("MainWindow", "Standard deviation in Y"))
        self.offspec_sigmay_spinbox.setSuffix(_translate("MainWindow", " 1/A"))
        self.label_44.setText(_translate("MainWindow", "Number of sigmas"))
        self.offspec_sigmas_spinbox.setToolTip(_translate("MainWindow", "Number of sigmas to average over"))
