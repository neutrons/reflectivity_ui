...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.leftEntries.setMinimumSize(QtCore.QSize(320, 0))
        ...
        self.load_live_data_button = QtWidgets.QPushButton(self.leftEntries)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.load_live_data_button.sizePolicy().hasHeightForWidth())
        self.load_live_data_button.setSizePolicy(sizePolicy)
        self.load_live_data_button.setObjectName("load_live_data_button")
        self.horizontalLayout_15.addWidget(self.load_live_data_button)
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 371, 132))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 322, 106))
        ...
        self.gridLayout_15.addWidget(self.fanReflectivity, 5, 1, 1, 2)
        ...
        self.gridLayout_15.addWidget(self.normalize_to_unity_checkbox, 4, 1, 1, 2)
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 226, 110))
        ...
        self.refresh_offspec = QtWidgets.QPushButton(self.OffSpec_Tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.refresh_offspec.sizePolicy().hasHeightForWidth())
        self.refresh_offspec.setSizePolicy(sizePolicy)
        self.refresh_offspec.setObjectName("refresh_offspec")
        self.horizontalLayout_9.addWidget(self.refresh_offspec)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1843, 20))
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/General/clearNorm.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionClear_Normalizations.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/General/cutPoints.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCut_Points.setIcon(icon12)
        self.actionCut_Points.setObjectName("actionCut_Points")
        self.actionAuto_Reflectivity = QtWidgets.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/General/autoRef.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAuto_Reflectivity.setIcon(icon13)
        self.actionAuto_Reflectivity.setObjectName("actionAuto_Reflectivity")
        self.actionStrip_Overlap = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/General/stripOverlap.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStrip_Overlap.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/General/autoNorm.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAutoNorm.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/General/exportRawData.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExport_Raw_Data.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/General/delNormalization.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_Normalization.setIcon(icon17)
        ...
        self.refresh_offspec.pressed.connect(MainWindow.refresh_offspec)
        ...
        self.load_live_data_button.clicked.connect(MainWindow.live_open)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.load_live_data_button.setText(_translate("MainWindow", "Load Live Data"))
        ...
        self.refresh_offspec.setToolTip(_translate("MainWindow", "Recalculate the offspecular data"))
        self.refresh_offspec.setStatusTip(_translate("MainWindow", "Recalculate the offspecular data"))
        self.refresh_offspec.setText(_translate("MainWindow", "Refresh"))
        ...
        self.actionNorm.setToolTip(_translate("MainWindow", "Take current data set as direct beam for wavelength normalization (Ctrl+W)"))
        ...
        self.actionClear.setToolTip(_translate("MainWindow", "Remove all data sets from the reduction list (CTRL+SHIFT+Q)"))
        ...
        self.actionClear_Normalizations.setToolTip(_translate("MainWindow", "Remove all data sets from the direct beam list (CTRL+SHIFT+W)"))
