...
options = {
    ...
    "30889": dict(
        sc="REF_M_30889",
        db="30886",
        path="/SNS/REF_M/IPTS-21391/nexus/REF_M_30889.nxs.h5",
    ...
    "30886": dict(
        sc="REF_M_30886",
        db="30886",
        path="/SNS/REF_M/IPTS-21391/nexus/REF_M_30886.nxs.h5",
        peak=[203, 223],
        bck=[4, 103],
        beam=[78, 180],
    ),
    "30887": dict(
        sc="REF_M_30887",
        db="30887",
        path="/SNS/REF_M/IPTS-21391/nexus/REF_M_30887.nxs.h5",
        peak=[202, 222],
        bck=[51, 88],
        beam=[80, 178],
    ),
    "30891": dict(
        sc="REF_M_30891",
        db="30887",
        path="/SNS/REF_M/IPTS-21391/nexus/REF_M_30891.nxs.h5",
    ...
    "30806": dict(
        sc="REF_M_30806",
        db="30794",
        path="/SNS/REF_M/IPTS-21391/nexus/REF_M_30806.nxs.h5",
    ...
    "30794": dict(
        sc="REF_M_30794",
        db="30794",
        path="/SNS/REF_M/IPTS-21391/nexus/REF_M_30794.nxs.h5",
        peak=[202, 216],
        bck=[5, 105],
        beam=[71, 175],
    ),
    "30906": dict(
        sc="REF_M_30906",
        db="30796",
        path="/SNS/REF_M/IPTS-21391/nexus/REF_M_30906.nxs.h5",
    ...
    "30796": dict(
        sc="REF_M_30796",
        db="30796",
        path="/SNS/REF_M/IPTS-21391/nexus/REF_M_30796.nxs.h5",
        peak=[202, 218],
        bck=[94, 104],
        beam=[82, 177],
    ),
    "31082": dict(
        sc="REF_M_31082",
        db="31079",
        path="/SNS/REF_M/IPTS-22123/nexus/REF_M_31082.nxs.h5",
    ...
    "31079": dict(
        sc="REF_M_31079",
        db="31079",
        path="/SNS/REF_M/IPTS-22123/nexus/REF_M_31079.nxs.h5",
        peak=[202, 218],
        bck=[94, 104],
        beam=[82, 177],
    ),
    "31083": dict(
        sc="REF_M_31083",
        db="31080",
        path="/SNS/REF_M/IPTS-22123/nexus/REF_M_31083.nxs.h5",
        ref="/SNS/users/m2d/MR/2019A/IPTS-22123/REF_M_31081+31082+31083_Specular_Off_Off_v2_test.dat",
        refcst="/SNS/users/m2d/MR/2019A/IPTS-22123/REF_M_31081+31082+31083_Specular_Off_Off_v2_test.dat",
        peak_pos=183.2,
        peak=[179, 188],
    ...
    "31080": dict(
        sc="REF_M_31080",
        db="31080",
        path="/SNS/REF_M/IPTS-22123/nexus/REF_M_31080.nxs.h5",
        peak=[200, 216],
        bck=[25, 75],
        beam=[82, 148],
    ),
